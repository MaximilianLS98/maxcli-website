      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Install in seconds. Contribute on GitHub. Join thousands of developers who've taken control of their command-line experience.
          </p>
        </div>

        {/* Installation Preview */}
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-8 mb-12 max-w-3xl mx-auto">
          <div className="text-left">
            ...
            <div className="space-y-3 font-mono">
              ...
              <div className="text-green-400">$ curl -sSL https://raw.githubusercontent.com/maxcli/install.sh | bash</div>
              <div className="text-gray-400"># Or with npm</div>
              <div className="text-green-400">$ npm install -g @maxcli/core</div>
              <div className="text-gray-300 mt-4">✅ Installation complete! Run 'maxcli --help' to get started.</div>
            </div>
          </div>
        </div>
