      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              The modular command-line powerhouse that adapts to your workflow. 
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="#" className="hover:text-green-400 transition-colors">GitHub Discussions</a></li>
              ...
              <li><a href="#" className="hover:text-green-400 transition-colors">Stack Overflow</a></li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 MaxCLI. Built with <Heart size={14} className="inline text-red-400 mx-1" /> by the open source community.
          </div>
