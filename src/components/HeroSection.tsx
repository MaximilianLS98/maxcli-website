...
import { GitBranch, Terminal, ArrowRight } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6 mt-4">
        ...
        <div className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-purple-300 text-sm font-medium">Open Source • Apache 2.0</span>
        </div>
        ...
        <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
          The open-source, modular toolkit that adapts to <em className="text-green-400 font-semibold">your</em> workflow – 
          enable only what you need.
        </p>
        
        {/* Terminal demo */}
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 mb-12 max-w-2xl mx-auto font-mono text-left">
          ...
          <div className="space-y-2">
            ...
            <div className="text-gray-300">MaxCLI v2.0 - Your Modular Command-Line Powerhouse</div>
            <div className="text-gray-300">Available modules: ssh, docker, gcp, coolify, setup, misc</div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button 
            className="bg-green-500 hover:bg-green-600 text-black font-semibold px-8 py-4 text-lg rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25"
          >
            Get Started
