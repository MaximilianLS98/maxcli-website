			...
			<div className='max-w-7xl mx-auto px-6'>
				<div className='text-center mb-16'>
					...
					<p className='text-xl text-gray-300 max-w-3xl mx-auto'>
						MaxCLI's modular architecture means you're in complete control. Turn
						features on or off with a simple command.
					</p>
				</div>
					...
					<div className='space-y-8'>
						...
						<div className='bg-gradient-to-r from-purple-500/10 to-green-500/10 border border-purple-500/20 rounded-xl p-6'>
							<p className='text-purple-300 font-medium'>
								💡 Pro Tip: Use{' '}
								<code className='bg-gray-800 px-2 py-1 rounded font-mono text-green-400 text-xs sm:text-sm break-all'>
									maxcli modules list
								</code>{' '}
